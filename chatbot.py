...
Original file is located at
    https://colab.research.google.com/drive/19uomp0wvrK304Ar2vF6BOKCJ9bOn6q1S
"""
...
print(chat_mistral("Explain Reinforcement Learning through Human Feedback (RLHF) in simple words."))

print(chat_mistral("list any RLHF Models if available"))
